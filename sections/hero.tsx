    ...
    >
      <div className="w-full max-w-6xl mx-auto text-center">
        ...
        <motion.h2
          ...
          className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-semibold text-muted-foreground mb-8"
        >
          {personalInfo.title}
        </motion.h2>
        ...
        <motion.p
          ...
          className="text-lg md:text-xl text-muted-foreground mb-10 leading-relaxed max-w-4xl mx-auto text-center"
        >
          {personalInfo.bio}
        </motion.p>
